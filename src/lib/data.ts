...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    location: "Detroit, MI",
    text: "The interior styling for our daughter's wedding was beyond anything we imagined. The floral installations, the draping — guests are still talking about it months later. Eleganté is in a class of their own.",
    rating: 5,
  },
  {
    id: "t3",
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tags: ["Styling", "Draping", "Installation", "Ceremony"],
    featured: true,
  },
  {
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: "Transforming venues into extraordinary luxury environments.",
    longDescription: "Every celebration deserves a setting as beautiful as the moment itself. Our interior styling team specialises in luxury weddings, galas, corporate events, and private parties — creating immersive environments that make guests feel they have stepped into another world.",
    heroImage: "/images/BW8A3877.webp",
    ...
    faqs: [
      ...
      { question: "Do you travel for destination projects?", answer: "Yes — we accept select destination project commissions. Travel and accommodation costs are included in project proposals." },
    ],
    featured: true,
  ...
  },
  {
    ...
    benefits: ["Fresh and preserved flower options", "Custom vessel and container sourcing", "Seasonal rotation programs", "Floral coordination", "Permanent installation design", "Ongoing maintenance programs"],
    process: PROCESS_STEPS,
    faqs: [
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Transforming Spaces with Floral Installations: Our Complete Guide",
    excerpt: "From intimate table arrangements to towering entrance installations, discover how florals create unforgettable atmospheres.",
    content: "...",
